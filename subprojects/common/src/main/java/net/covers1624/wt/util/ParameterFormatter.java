 ...
 * Copied appendSpecificTypes from org.apache.logging.log4j.util.StringBuilders to remove hard dependency.
 * Made {@link #format(String, Object...)} Vargs.
 */
public final class ParameterFormatter {
     ...
     * @param arguments      the arguments to be used to replace placeholders.
     */
    public static void formatMessage2(final StringBuilder buffer, final String messagePattern, final Object[] arguments, final int argCount, final int[] indices) {
     ...
     * @param arguments      the arguments to be used to replace placeholders.
     */
    public static void formatMessage3(final StringBuilder buffer, final char[] messagePattern, final int patternLength, final Object[] arguments, final int argCount, final int[] indices) {
        if (messagePattern == null) {
            return;
        }
     ...
     * @param arguments      the arguments to be used to replace placeholders.
     */
    public static void formatMessage(final StringBuilder buffer, final String messagePattern, final Object[] arguments, final int argCount) {
        if (messagePattern == null || arguments == null || argCount == 0) {
            buffer.append(messagePattern);
            return;
        }
    ...
    public static boolean isDelimPair(final char curChar, final String messagePattern, final int curCharIndex) {
    ...
    public static void handleRemainingCharIfAny(final String messagePattern, final int len, final StringBuilder buffer, final int escapeCounter, final int i) {
        if (i == len - 1) {
            final char curChar = messagePattern.charAt(i);
    ...
    // Profiling showed this method is important to log4j performance. Modify with care!
    // 28 bytes (allows immediate JVM inlining: < 35 bytes) LOG4J2-1096
    public static void handleLastChar(final StringBuilder buffer, final int escapeCounter, final char curChar) {
        if (curChar == ESCAPE_CHAR) {
    ...
    public static void handleLiteralChar(final StringBuilder buffer, final int escapeCounter, final char curChar) {
    ...
    public static void writeDelimPair(final StringBuilder buffer) {
    ...
    // Profiling showed this method is important to log4j performance. Modify with care!
    // 11 bytes (allows immediate JVM inlining: < 35 bytes) LOG4J2-1096
    public static void writeEscapedEscapeChars(final int escapeCounter, final StringBuilder buffer) {
    ...
    public static void writeArgOrDelimPair(final Object[] arguments, final int argCount, final int currentArgument, final StringBuilder buffer) {
     ...
     */
    public static void recursiveDeepToString(final Object o, final StringBuilder str, final Set<String> dejaVu) {
    ...
    public static boolean appendSpecialTypes(final Object o, final StringBuilder str) {
        return appendSpecificTypes(str, o) || appendDate(o, str);
    }

    //Copied from org.apache.logging.log4j.util.StringBuilders.
    // Removed else if block for org.apache.logging.log4j.util.StringBuilderFormattable handling
    // Otherwise unchanged.
    ...
    public static boolean appendDate(final Object o, final StringBuilder str) {
     ...
     */
    public static boolean isMaybeRecursive(final Object o) {
        return o.getClass().isArray() || o instanceof Map || o instanceof Collection;
    }

    public static void appendPotentiallyRecursiveValue(final Object o, final StringBuilder str, final Set<String> dejaVu) {
    ...
    public static void appendMap(final Object o, final StringBuilder str, Set<String> dejaVu) {
    ...
    public static void appendCollection(final Object o, final StringBuilder str, Set<String> dejaVu) {
    ...
    public static void tryObjectToString(final Object o, final StringBuilder str) {
    ...
    public static void handleErrorInObjectToString(final Object o, final StringBuilder str, final Throwable t) {
